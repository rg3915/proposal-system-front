<script lang="ts">
  ...
  import { AlbumArtwork } from "./(components)/index.js";
      ...
      <Tabs.Root value="all">
        <div class="flex items-center">
          <Tabs.List>
            ...
            <Tabs.Trigger value="active">Fora de linha</Tabs.Trigger>
          </Tabs.List>
          <div class="ml-auto flex items-center gap-2">
            <DropdownMenu.Root>
              ...
              <DropdownMenu.Content align="end">
                ...
                <DropdownMenu.CheckboxItem>Fora de linha</DropdownMenu.CheckboxItem>
              </DropdownMenu.Content>
            </DropdownMenu.Root>
          ...
          <Card.Root>
            ...
            <Card.Footer>
              <div class="text-muted-foreground text-xs">
                Showing <strong>1-10</strong> of <strong>32</strong> Produtos
              </div>
            </Card.Footer>
          </Card.Root>
        </Tabs.Content>
