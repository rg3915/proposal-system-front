    ...
    >
      ...
      <Breadcrumb.Root class="hidden md:flex">
        <Breadcrumb.List>
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Link href="##">Orçamentos</Breadcrumb.Link>
          </Breadcrumb.Item>
          <Breadcrumb.Separator />
          <Breadcrumb.Item>
        ...
        <Tabs.Content value="all">
          <Card.Root>
            <Card.Header>
              ...
              <Card.Description>
                Gerencie seus Orçamentos e veja o desempenho de suas vendas.
              </Card.Description>
            </Card.Header>
            <Card.Content>
              <Table.Root>
                  ...
                  <Table.Row>
                    <Table.Cell class="hidden sm:table-cell">
                      <img
                        ...
                        height="64"
                        src="https://res.cloudinary.com/euroled/image/upload/c_limit,h_100/f_auto,q_auto/v1/media/produtos/EL-BR-LA-24003-SA-BU-30_zai5as"
                        width="64"
                      />
                    </Table.Cell>
            ...
            <Card.Footer>
              <div class="text-muted-foreground text-xs">
                Showing <strong>1-10</strong> of <strong>32</strong> Orçamentos
              </div>
            </Card.Footer>
          </Card.Root>
        </Tabs.Content>
